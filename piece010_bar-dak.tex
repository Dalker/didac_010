...
partie par la conception d'un wiki par chaque groupe. Une fois ce travail
...
Conclusion prévue: les élèves pourrant par la suite, en tant que ``citoyens
numériques'', contribuer à Wikipedia s'ils le souhaitent. Ils ont eu une
première expérience de travail avec un Wiki et sont donc compétents pour le faire.
...
[ne pas hésiter à prendre des bouts de machins ci-dessous ou ci-dessus et les
ramener ici]
...
[mettre de l'ordre ci-dessus et finir avec quelque chose qui ressemble à une fin]
